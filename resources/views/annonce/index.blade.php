                    ...
                    <tbody>
                        ...
                        @foreach ($annonces as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('annonce.show',$item->uuid)}}" class="btn btn-primary waves-light waves-effect"><i class="fa fa-exclamation-circle"></i></a>
                                    <a href="{{route('annonce.edit',$item->uuid)}}" class="btn btn-success waves-light waves-effect"><i class="mdi mdi-pencil"></i></a>
