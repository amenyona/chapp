        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('auth.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mt-4">
                            <a href="{{route('auth.listeusers')}}" class="btn btn-primary waves-effect waves-light btn-sm">Aller &agrave; la liste <i class="mdi mdi-arrow-left ms-1"></i></a>
                        </div>
                        <br>
                        <div class="col-sm-6">
                            <div class="mb-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="eglise">
                                    ...
                                    <option value="{{$item->id}}" {{ ( $item->id == $egliseid) ? 'selected' : '' }}>{{$item->nom}}</option>    
                                    @endforeach
