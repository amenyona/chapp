                                            ...
                                            <div class="col-xl-2">
                                                <div class="product-detai-imgs">
                                                    <div class="row">
                                                        ...
                                                        <div class="mt-2">
                                                            <a href="{{route('commentaire.mescommentaires')}}" class="btn btn-primary waves-effect waves-light btn-sm">Aller &agrave; la liste <i class="mdi mdi-arrow-left ms-1"></i></a>
                                                        </div>
                                                        @endif
                                                         @if (renvoiRoleUserSimple(Auth::user()->id))
                                                        <div class="mt-2">
                                                            <a href="{{route('commentaire.mescommentaires')}}" class="btn btn-primary waves-effect waves-light btn-sm">Aller &agrave; la liste <i class="mdi mdi-arrow-left ms-1"></i></a>
                                                        </div>
                                                        @endif
                                                ...
                                                <div class="mt-4 mt-xl-3">
                                                    ...
                                                    @if (renvoiRoleUser(Auth::user()->id) || renvoiRoleUserP(Auth::user()->id)|| renvoiRoleUserS(Auth::user()->id))
                                                        <div class="col-md-6">
                                                            ...
                                                            <div>
                                                                <p class="textForm"><i class="me-2 text-primary "></i>Nom: {{renvoiUserName($commentaire['iduser'])}}</p>
                                                                <p class="textForm"><i class="me-2 text-primary "></i>Email: {{renvoiUserEmail($commentaire['iduser'])}}</p>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Article: {{renvoiArticleTitre($commentaire['articleId'])}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Contenu: <?php echo $commentaire['contenu']; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
