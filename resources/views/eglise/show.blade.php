                                            ...
                                            <div class="col-xl-10">
                                                <div class="mt-4 mt-xl-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <div>
                                                                <p class="textForm"><i class="me-2 text-primary "></i>Nom: {{strtoupper($eglise->nom)}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Dioc&egrave;se: {{$eglise->diocese}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i> Ville: {{$eglise->ville}}</p>
                                                                
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i> Adresse: {{$eglise->adresse}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Email: {{$eglise->email}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Pays: {{implode(',',$eglise->pays()->get()->pluck('nom')->toArray())}}</p>
