    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4">
                    <a href="#" class="btn btn-primary waves-effect waves-light btn-sm">Cr&eacute;er r&ocirc;le<i class="mdi mdi-arrow-right ms-1"></i></a>
                </div>
                ...
                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                 ...
                 <div style="text-align: center;">
                    <nav aria-label="...">
                            <ul class="pagination">
                              <li class="page-item">
                                <a class="page-link" href="#">Pr&eacute;c&eacute;dent</a>
