                                            ...
                                            <div class="col-xl-8">
                                                <div class="mt-4 mt-xl-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <div>
                                                                <p class="textForm"><i class="me-2 text-primary "></i>Nom: {{$pays->nom}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Capitale: {{$pays->capitale}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i> Indicatif: {{$pays->indicatif}} </p>
                                                                
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Reduction Max: {{$pays->plusieurmessededuction}}</p>
                                                                <p class="textForm"><i class="font-size-16 align-middle text-primary me-1"></i>Reduction Min: {{$pays->deuxmessededuction}}</p>
