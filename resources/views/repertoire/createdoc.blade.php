                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Créer Document</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Documents</a></li>
                                            <li class="breadcrumb-item active">Créer Document</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    @endif
                                        <form action="{{ route('repertoire.storedoc') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="results">
