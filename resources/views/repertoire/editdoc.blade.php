                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Modifier Document</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    @if (renvoiRoleUser(session('LoggedUser')))
                                        <div class="mt-4">
                                            <a href="{{route('repertoire.listeFiles',$repertoire->uuid)}}" class="btn btn-primary waves-effect waves-light btn-sm">Aller à la liste<i class="mdi mdi-arrow-left ms-1"></i></a>
                                        </div>
                                    @endif
                                        <form action="{{route('repertoire.updateDoc',$document->uuid)}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="results">
                                            ...
                                            <div data-repeater-list="outer-group" class="outer">
                                                <div data-repeater-item class="outer">
                                                    <div class="form-group row mb-4">
                                                        <label for="titre" class="col-form-label col-lg-2">Document</label>
                                                        <div class="col-lg-10">
                                                            <embed src="{{url('upload/',$document->imageDoc)}}" width="100px" height="100px">
                                                        </div>
                                                    </div>
                                                   
                                                    <div class="form-group row mb-4">
                                                        <label class="col-form-label col-lg-2">Titre</label>
                                                        <div class="col-lg-10">
                                                            <input class="form-control" type="text" id="titre" name="titre" value="{{$document->titre}}" required>
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea id="taskdesc-editor" name="contenu" required><?php echo $document->description;  ?></textarea>
                                                        </div>
                                                        <span class="text-danger">@error('contenu'){{ $message }}
                                                            @enderror
                                                         </span>
                                                         <input type="hidden" value="{{$repertoire->id}}" name="idrep">
                                                         <input type="hidden" value="{{$document->id}}" name="iddocument">
                                                    </div>
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <span class="text-danger">@error('image'){{ $message }}
                                                             ...
                                                             <input type="hidden" name="my_image" value="{{$document->imageDoc}}">
                                                        </div>
                                                    </div>
