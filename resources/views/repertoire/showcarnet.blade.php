                            ...
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="mt-4 mb-sm-0 font-size-18">
                                        <a href="{{route('repertoire.listeFiles',implode(',',$carnet->repertoire()->get()->pluck('uuid')->toArray()))}}" class="btn btn-primary waves-effect waves-light btn-sm">Aller à la liste <i class="mdi mdi-arrow-left ms-1"></i></a>
                                      </div>
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="col-md-7 offset-md-1 col-sm-9 col-8">
                                                            <div class="tab-content" id="v-pills-tabContent">
                                                                <div class="tab-pane fade show active" id="product-1" role="tabpanel" aria-labelledby="product-1-tab">
                                                                    <div>
                                                                        <embed  src="{{url('upload',$carnet->imageCarnet)}}" width="300px" height="500px">
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mt-4 mt-xl-3">
                                                    ...
                                                    <h4 class="mt-1 mb-3">{{implode(',',$carnet->user()->get()->pluck('name')->toArray())}} {{implode(',',$carnet->user()->get()->pluck('firstname')->toArray())}}</h4> 
                                                    <h4 class="mt-1 mb-3"><i class="bx bx-envelope"></i>{{implode(',',$carnet->user()->get()->pluck('email')->toArray())}}</h4>                                               
                                                     
                                                    <h5 class="mb-4">Dossier contenant : {{implode(',',$carnet->repertoire()->get()->pluck('nom')->toArray())}}</h5>
